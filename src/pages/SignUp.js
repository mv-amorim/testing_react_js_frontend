...
export default function Login() {
  ...
  const performRegister = async () => {
    ...
    try {
      ...
      if (valid) {
        const res = await fetch("http://localhost:4000/user/cadaster", {
          method: 'POST',
          headers: {
        ...
        if (res.ok) {
          setSnackbarContent({
            message: "Registred as " + body.user.name,
            severity: 'success'
          });
  ...
  return (
    ...
    >
      <Helmet>
        <title>Sing up - Testing ReactJS</title>
      </Helmet>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Button variant="contained" disableElevation onClick={performRegister}>
                Register
              </Button>
            </Box>
          </Box>
